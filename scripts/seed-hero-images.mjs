...
const churchPages = [
  { id: 'worshipPage', file: 'hero-worship.webp', alt: 'The sanctuary of Second Presbyterian set for Sunday worship', eyebrow: `Sunday Worship`, headline: `There's a place for you here.`, subhead: `Whether you're a weekly churchgoer, haven't been in ages, or don't know anything about Christianity, you are welcome at Second.` },
  { id: 'beliefsPage', file: 'tiffany-windows.webp', alt: 'A Tiffany stained-glass window at Second Presbyterian', eyebrow: `What We Believe`, headline: `The faith we share`, subhead: `What we hold to be true about humanity, about God, and about the good news of Jesus Christ.` },
  { id: 'musicPage', file: 'hero-music.webp', alt: 'The historic Austin pipe organ in the Second Presbyterian sanctuary', eyebrow: `Music`, headline: `Our musical life at Second`, subhead: `I will sing of your strength, in the morning I will sing of your love. (Psalm 59:16)` },
  { id: 'staffPage', file: 'hero-staff.webp', alt: 'The sanctuary of Second Presbyterian Church', eyebrow: `Pastors & Staff`, headline: `The people you'll meet at Second`, subhead: `A small, dedicated team serving a historic congregation in the South Loop.` },
  { id: 'growPage', file: 'hero-grow.webp', alt: 'Inside the historic sanctuary at Second Presbyterian', eyebrow: `Get Involved`, headline: `Community Groups at Second`, subhead: `Drop in and walk with others on the Way of Jesus.` },
  { id: 'servePage', file: 'hero-exterior.webp', alt: 'Second Presbyterian Church on South Michigan Avenue', eyebrow: `Get Involved`, headline: `Love our neighbors`, subhead: `We are called to serve and celebrate Jesus for the good of the world. Much of that happens right here in the South Loop.` },
  { id: 'kidsPage', file: 'sanctuary-interior.webp', alt: 'The welcoming nave of Second Presbyterian', eyebrow: `Get Involved`, headline: `Children are welcome here`, subhead: `At Second, little ones are part of the worshipping congregation, and we welcome their noise and their needs.` },
  { id: 'foodPage', file: 'hero-food.webp', alt: 'Neighbors sharing a meal at the South Loop Community Table at Second Presbyterian', eyebrow: `Food Ministry`, headline: `Food for all in need, no questions asked`, subhead: `Find us at our Cullerton door on Tuesday, Wednesday, Thursday, and Sunday.` },
  { id: 'useOurSpacePage', file: 'hero-space.webp', alt: 'The historic sanctuary interior available to rent at Second Presbyterian', eyebrow: `Use Our Space`, headline: `Interested in using space at Second?`, subhead: `A historic, welcoming building in the heart of the South Loop, open to the wider community throughout the week.` },
  { id: 'weddingsPage', file: 'hero-weddings.webp', alt: 'The sanctuary aisle beneath the Tiffany windows at Second Presbyterian', eyebrow: `Weddings`, headline: `Get married in a National Historic Landmark`, subhead: `Our 1901 Arts and Crafts sanctuary, home to nine Tiffany windows and extraordinary murals, draws visitors from all over the world. We host weddings of every size.` },
  { id: 'givePage', file: 'mural-angels.jpg', alt: 'The painted angels on the sanctuary ceiling at Second Presbyterian', eyebrow: `Give`, headline: `Thank you`, subhead: `For entrusting your tithes and offerings to Second. Your generosity sustains worship, music, and a food ministry that feeds our neighbors.` },
];
...
const existingPages = [
  { id: 'aboutPage', file: 'angel-murals.jpg', alt: 'The painted angels on the sanctuary ceiling at Second Presbyterian' },
  { id: 'eventsPage', file: 'hero-events.webp', alt: 'A gathering inside the historic sanctuary at Second Presbyterian' },
  { id: 'sermonsPage', file: 'hero-worship.webp', alt: 'The sanctuary at Second Presbyterian set for worship' },
  { id: 'privacyPage', file: 'hero-sanctuary.webp', alt: 'Second Presbyterian Church on South Michigan Avenue' },
  { id: 'faqPage', file: 'sanctuary-interior.webp', alt: 'Inside the sanctuary at Second Presbyterian' },
  { id: 'contactPage', file: 'hero-sanctuary.webp', alt: 'Second Presbyterian Church on South Michigan Avenue' },
];
...
async function run() {
  ...
  for (const p of existingPages) {
    ...
    await client.patch(p.id).set({ heroImage: img(assetId, p.alt) }).commit();
