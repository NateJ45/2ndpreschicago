...
> **Project:** this repo is the Second Presbyterian Church of Chicago site. It commits to `main` (renamed from `master` 2026-09-05); Cloudflare Workers Builds deploys `main` automatically, and `staging` deploys to the staging Worker through `deploy-staging.yml`. Services was removed; an Events module is enabled.
>
