...
import { SINGLETON_PAGE_PATHS } from '@/sanity/urls';
...
// Derived from the one page map so it cannot fall out of step.
const PAGE_SINGLETONS = Object.keys(SINGLETON_PAGE_PATHS);
...
export const GET: APIRoute = async ({ cookies, url, request }) => {
  ...
  upstream.searchParams.set('tag', 'secondpres.preview-live');
