...
export const homePage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      options: { hotspot: true },
      description:
        'Optional. A still image shown while the video loads. Used only when a hero video is set.',
      fields: [defineField({ name: 'alt', title: 'Alt text', type: 'string' })],
    }),
    ...
    defineField({
      ...
      description:
        'Temporarily replace the home hero for a season (Advent, Christmas, Holy Week, Easter).',
      fields: [
        defineField({
          name: 'enabled',
          title: 'Enable seasonal hero',
          type: 'boolean',
          initialValue: false,
        }),
        ...
        defineField({
          ...
          type: 'string',
          description: 'Optional. Defaults to "Plan a Visit".',
        }),
        defineField({
          name: 'primaryCtaUrl',
          title: 'Primary button link',
          type: 'string',
          description: 'Internal path like "/events" or a full URL.',
        }),
      ],
    }),
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          title: 'Date label',
          type: 'string',
          description: 'Example: "Sunday, June 7" or "This Sunday".',
        }),
        ...
        defineField({
          ...
          title: 'Scripture',
          type: 'string',
          description: 'Example: "John 1:1-14".',
        }),
        ...
        defineField({
          ...
          title: 'Note',
          type: 'string',
          description: 'Optional extra line (e.g. "Communion Sunday").',
        }),
      ],
    }),
    ...
    defineField({
      ...
      type: 'string',
      group: 'final',
      initialValue: 'Whoever you are, you are welcome here.',
    }),
    defineField({
    ...
    defineField({
      ...
      options: { hotspot: true },
      description:
        'The arched photo beside the Welcome text. Leave empty to use the built-in sanctuary-interior photo.',
      fields: [defineField({ name: 'alt', title: 'Alt text', type: 'string' })],
    }),
    defineField({
      name: 'serviceBand',
      ...
      fields: [
        defineField({
          ...
          title: 'Worship label',
          type: 'string',
          description: 'Example: "Sunday Worship".',
        }),
        ...
        defineField({
          name: 'joinLabel',
          title: 'How-to-join label',
          type: 'string',
          description: 'Example: "How to join".',
        }),
        defineField({
          name: 'joinNote',
          title: 'How-to-join note',
          type: 'text',
          rows: 2,
          description: 'Example: "In person and online. Communion the first Sunday of each month."',
        }),
        defineField({
          name: 'whereLabel',
          title: 'Where label',
          type: 'string',
          description: 'Example: "Where". The address itself comes from Site Settings.',
        }),
      ],
    }),
    defineField({
        ...
        defineArrayMember({
          ...
          fields: [
            ...
            defineField({
              ...
              title: 'When',
              type: 'string',
              description: 'Example: "Sundays, 11am".',
              validation: (R) => R.required(),
            }),
          ],
    ...
    defineField({
      name: 'eventsEyebrow',
      title: 'Events teaser — eyebrow',
      type: 'string',
      group: 'content',
    }),
    defineField({
      name: 'eventsHeadline',
      title: 'Events teaser — headline',
      type: 'string',
      group: 'content',
    }),
    defineField({
      name: 'eventsIntro',
      title: 'Events teaser — intro',
      type: 'text',
      rows: 2,
      group: 'content',
    }),
    defineField({
      name: 'inclusiveStatement',
      title: 'Inclusive welcome — statement',
      type: 'text',
      rows: 2,
      group: 'content',
    }),
    defineField({
      name: 'inclusiveBody',
      title: 'Inclusive welcome — body',
      type: 'text',
      rows: 2,
      group: 'content',
    }),
    defineField({
      name: 'involvedEyebrow',
      title: 'Get involved — eyebrow',
      type: 'string',
      group: 'content',
    }),
    defineField({
      name: 'involvedHeadline',
      title: 'Get involved — headline',
      type: 'string',
      group: 'content',
    }),
    defineField({
      name: 'involvedSubhead',
      title: 'Get involved — subhead',
      type: 'text',
      rows: 2,
      group: 'content',
    }),
    ...
    defineField({
      name: 'welcomeCtaPrimary',
      title: 'Welcome button 1',
      type: 'ctaBlock',
      group: 'content',
    }),
    defineField({
      name: 'welcomeCtaSecondary',
      title: 'Welcome button 2',
      type: 'ctaBlock',
      group: 'content',
    }),
    defineField({
      name: 'serviceBandVisitCta',
      title: 'Service band — Plan a Visit button',
      type: 'ctaBlock',
      group: 'content',
    }),
    defineField({
      name: 'serviceBandWatchCta',
      title: 'Service band — Watch button',
      type: 'ctaBlock',
      group: 'content',
    }),
    defineField({
      name: 'eventsCalendarCta',
      title: 'Events teaser — calendar button',
      type: 'ctaBlock',
      group: 'content',
    }),
