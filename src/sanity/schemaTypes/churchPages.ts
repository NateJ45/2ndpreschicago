  ...
  },
  {
    ...
    fields: [
      ...
      defineField({
        ...
        options: { hotspot: true },
        description:
          'The arched photo in the children-in-worship section. Leave empty to use the built-in Tiffany-windows photo.',
        fields: [defineField({ name: 'alt', title: 'Alt text', type: 'string' })],
      }),
      defineField({
        name: 'quoteText',
  ...
  },
  {
    ...
    fields: [
      ...
      defineField({
        ...
        options: { hotspot: true },
        description:
          'The arched photo in the organ section. Leave empty to use the built-in mural photo.',
        fields: [defineField({ name: 'alt', title: 'Alt text', type: 'string' })],
      }),
      defineField({
