...
export const sermonsPage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'url',
      description:
        'Where Sunday worship streams (e.g. the church YouTube). Shown as the Watch Live button.',
    }),
    ...
    defineField({
      ...
      type: 'string',
      description:
        'Label for the Watch Live button. The button link stays the livestream URL above. Leave empty to use the built-in default.',
    }),
    defineField({
      name: 'watchYoutubeLabel',
      title: 'Watch on YouTube button label',
      type: 'string',
      description:
        'Label for the Watch on YouTube button in the empty-state. Leave empty to use the built-in default.',
    }),
    defineField({
      name: 'emptyVisitCta',
      title: 'Empty-state "Plan a Visit" button',
      type: 'ctaBlock',
      description:
        'The Plan a Visit button shown when no sermons are loaded. Leave empty to use the built-in default button.',
    }),
    ...
    defineField({
      ...
      title: 'Sermon detail — closing CTA eyebrow',
      type: 'string',
      description:
        'Shown in the closing band at the bottom of every individual sermon page. Leave empty to use the built-in default.',
    }),
    defineField({
      name: 'detailFinalCtaHeadline',
      title: 'Sermon detail — closing CTA headline',
      type: 'string',
      description:
        'Shown in the closing band at the bottom of every individual sermon page. Leave empty to use the built-in default.',
    }),
    defineField({
      ...
      title: 'Sermon detail — closing CTA subhead',
      type: 'text',
      rows: 2,
      description:
        'Shown in the closing band at the bottom of every individual sermon page. Leave empty to use the built-in default.',
    ...
    defineField({
      name: 'detailFinalCta',
      title: 'Sermon detail — closing CTA button',
      type: 'ctaBlock',
      description:
        'The button in the closing band at the bottom of every individual sermon page. Leave empty to use the built-in default button.',
    }),
    defineField({
