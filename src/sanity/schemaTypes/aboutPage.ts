...
export const aboutPage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      group: 'hero',
      initialValue: 'A landmark church with an open door',
    }),
    defineField({
      name: 'heroSubhead',
      title: 'Hero subhead',
    ...
    defineField({
      name: 'featureImage',
      title: 'Mural feature photo',
      type: 'image',
      group: 'content',
      options: { hotspot: true },
      description:
        'The large arched photo near the top (the painted angels). Leave empty to use the built-in photo.',
      fields: [defineField({ name: 'alt', title: 'Alt text', type: 'string' })],
    }),
    defineField({
      name: 'muralCaption',
    ...
    defineField({
      name: 'buildingEyebrow',
      title: 'Building — eyebrow',
      type: 'string',
      group: 'content',
    }),
    defineField({
      name: 'buildingHeadline',
      title: 'Building — headline',
      type: 'string',
      group: 'content',
    }),
    defineField({
      name: 'buildingBodyP1',
      title: 'Building — paragraph 1',
      type: 'text',
      rows: 3,
      group: 'content',
    }),
    ...
    defineField({
      ...
      options: { hotspot: true },
      description:
        'The arched photo beside "The building" text (the nave). Leave empty to use the built-in photo.',
      fields: [defineField({ name: 'alt', title: 'Alt text', type: 'string' })],
    }),
    defineField({
      name: 'whoEyebrow',
    ...
    defineField({
      name: 'buildingCta',
      title: 'Building — Visit/Use the Space button',
      type: 'ctaBlock',
      group: 'content',
    }),
    defineField({
      name: 'whoCtaPrimary',
      title: 'Who we are button 1',
      type: 'ctaBlock',
      group: 'content',
    }),
    defineField({
      name: 'whoCtaSecondary',
      title: 'Who we are button 2',
      type: 'ctaBlock',
      group: 'content',
    }),
