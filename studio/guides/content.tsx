...
export const guides: Guide[] = [
  // 1 ----------------------------------------------------------------------
  {
    ...
    body: [
      ...
      { kind: 'h', text: 'See your change before it goes live' },
      {
        kind: 'p',
        text: 'Most pages have a **Preview** tab at the top of the editor. Click it to see your draft on the real page, right next to the editor. Use it to check your work before you publish.',
      },
    ...
    body: [
      ...
      { kind: 'h', text: 'Make an edit' },
      {
        ...
        items: [
          ...
          'Click the **Preview** tab to see it on the real page.',
          'Click **Publish**.',
        ],
      },
    ...
    body: [
      ...
      { kind: 'h', text: 'Add a section' },
      {
        ...
        items: [
          ...
          'Fill in its fields. Use the **Preview** tab to see it.',
          'Publish.',
        ],
      },
